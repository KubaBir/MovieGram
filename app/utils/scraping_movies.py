...
def adding_to_profile_func(filmweb_nick, user):
    ...
    gatunki = {"akcja": ['sensacyjny', 'wojenny', 'kryminał', 'gangsterski', 'fantasy', 'akcja', "western", "true crime", "sztuki walki", 'szpiegowski', 'film-noir'],
               ...
               "animacja": ['animacja', 'anime', 'animacja dla dorosłych'],
               'sci-fi': ['sci-fi'],
               ...
               "horror": ['horror'],
               "thriller": ["thriller"],
               "dokumentalny": ["dokumentalny", 'przyrodniczy', 'historyczny', 'dokumentalizowany'],
               "swiateczny": ['świąteczny'], 'polityczny': ['propagandowy', 'polityczny'],
               'artystyczny': ['poetycki', 'muzyczny', 'musical']}
